    ...
    <section className="prefooter" id="contact">
      <div className="prefooter-inner">
        ...
        <p className="prefooter-desc">
          Tell us what you need a booking system, a mobile app, an AI
          integration, or a complete platform. We&apos;ll tell you exactly what
          it takes.
        </p>
        <div className="prefooter-cta">
          <button
            className="btn-primary"
            id="btn-prefooter-start"
          ...
          <a
            href="tel:+923040260023"
            className="btn-outline"
            id="btn-prefooter-talk"
          >
            <span>Call Us</span>
          </a>
        </div>
